...
HD_PWD='C:/Fontys/Impl_PID/Impl_PID.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log impl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source impl_wrapper.tcl
