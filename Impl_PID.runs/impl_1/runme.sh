...
HD_PWD='C:/Fontys/Impl_PID/Impl_PID.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log impl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source impl_wrapper.tcl -notrace
