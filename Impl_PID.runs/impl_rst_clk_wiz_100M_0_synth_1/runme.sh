...
HD_PWD='C:/Fontys/Impl_PID/Impl_PID.runs/impl_rst_clk_wiz_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log impl_rst_clk_wiz_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source impl_rst_clk_wiz_100M_0.tcl
