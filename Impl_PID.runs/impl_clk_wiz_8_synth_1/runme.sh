...
HD_PWD='C:/Fontys/Impl_PID/Impl_PID.runs/impl_clk_wiz_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log impl_clk_wiz_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source impl_clk_wiz_8.tcl
