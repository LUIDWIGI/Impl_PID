...
#
# Generated by export_simulation on Fri Jan 19 10:05:56 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './impl.sh' script.
...
./impl.sh -noclean_files

For more information on the script, please type './impl.sh -help'.
