...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L sim_clk_gen_v1_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot impl xil_defaultlib.impl xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  impl -key {Behavioral:sim_1:Functional:impl} -tclbatch cmd.tcl -protoinst "protoinst_files/impl.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb impl.wdb xsim.dir)
